...
export const adminCreatedUserEmail = (user) =>
  baseTemplate(
    "Your Rishabh Guest House Account Has Been Created",
    `
    ...
    <p style="margin: 0 0 20px 0; color: #2a2a2a;">
      Your account has been created for <strong style="color: #0B1957;">Rishabh Guest House</strong>.
    </p>
    ...
    ">
      ...
      <div style="background: #ffffff; padding: 16px; border-radius: 8px; margin-bottom: 12px;">
        ...
        <p style="margin: 0; color: #2a2a2a; font-size: 14px;">
          Your password was set during account creation by the super admin.
        </p>
      </div>
      <p style="margin: 12px 0 0 0; color: #dc2626; font-size: 13px; font-weight: 600;">
        ⚠️ Please keep your login details secure.
      </p>
    </div>
